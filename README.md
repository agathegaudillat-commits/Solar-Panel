...
- **Motivation**: Why is this project important? What question are we answering for the client?  
- **Scope**: Briefly define the boundaries of the project (what is included/excluded).  
